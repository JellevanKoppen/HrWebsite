<!-- Footer -->
<footer class="page-footer font-small blueFooter pt-4">
    ...
    <div class="container-fluid text-center text-md-left">
      ...
      <div class="row">
        ...
        <div class="col-md-6 mt-md-0 mt-3">
          ...
          <!-- Content -->
          <h5 class="text-uppercase">Clearskies</h5>
          <p>Handige links op de website</p>
    ...
    <!-- Copyright -->
    <div class="footer-copyright text-center py-3">© <?php echo date("Y");?> All Rights Reserved.
      <a href="https://clearskies.me/"> Clearskies.me</a>
    </div>
    <!-- Copyright -->
